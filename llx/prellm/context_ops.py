...
def compress_codebase_folder(
    compress_folder: bool, codebase_path: str | Path | None
...
def generate_context_schema(
    collect_env: bool, compress_folder: bool, shell_ctx: Any, compressed: Any
) -> dict[str, Any]:
...
def build_sensitive_filter(
    sanitize: bool, sensitive_rules: str | Path | None, extra_context: dict[str, Any]
) -> Any:
...
def initialize_context_components(
    memory_path: str | Path | None, codebase_path: str | Path | None
) -> tuple[Any, Any]:
