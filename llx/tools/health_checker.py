...
class HealthChecker:
    ...
    def __init__(self, project_root: str = None):
        ...
        self.endpoints = {
            ...
            "redis": {"url": "redis://localhost:6379", "timeout": 3},
            "vscode": {"url": "http://localhost:8080", "timeout": 5},
        }
    ...
    def _check_redis_health(
        self, endpoint: Dict[str, Any], result: Dict[str, Any], start_time: float
    ) -> None:
        try:
            subprocess.run(
                ["redis-cli", "ping"], capture_output=True, text=True, timeout=endpoint["timeout"]
            )
    ...
    def _populate_service_details(
        self, service_name: str, endpoint: Dict[str, Any], result: Dict[str, Any]
    ) -> None:
    ...
    def _check_http_health(
        self, service_name: str, endpoint: Dict[str, Any], result: Dict[str, Any], start_time: float
    ) -> None:
    ...
    def check_container_health(self, container_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"container": container_name, "status": "error", "error": str(e)}
    ...
    def check_system_resources(self) -> Dict[str, Any]:
        ...
        try:
            ...
            resources["disk"]["usage"] = (
                ((total_space - available_space) / total_space * 100) if total_space > 0 else 0
            )
    ...
    def check_filesystem_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for dirname in directories:
                ...
                perm_info = {"exists": dir_path.exists(), "readable": False, "writable": False}
    ...
    def check_network_connectivity(self) -> Dict[str, Any]:
        ...
        try:
            ...
            critical_ports = {4000: "llx API", 11434: "Ollama", 6379: "Redis", 8080: "VS Code"}
    ...
    def monitor_services(self, interval: int = 30, duration: int = 300) -> Dict[str, Any]:
        ...
        while time.time() - start_time < duration:
            timestamp = time.time()
            data_point = {"timestamp": timestamp, "services": {}}
            ...
            for service_name, service_data in data_point["services"].items():
                ...
                response_time = (
                    f" ({service_data.get('response_time', 0):.0f}ms)"
