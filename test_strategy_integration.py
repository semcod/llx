...
from llx.planfile.models import Strategy, Goal, Sprint, TaskPattern, TaskType
...
def test_strategy_models():
    ...
    goal = Goal(
        short="Test strategy", quality=["Test coverage > 80%"], delivery=["Deploy in 2 weeks"]
    )
    ...
    strategy = Strategy(
        ...
        goal=goal,
        sprints=[
            Sprint(id=1, name="Test Sprint", objectives=["Test objective"], tasks=["test-task"])
        ],
        tasks={
            "patterns": [
                TaskPattern(
...
def test_strategy_validation():
    ...
    try:
        ...
        invalid_data = {
            ...
            "project_type": "web",
            "domain": "test",
            "goal": {"short": "Test", "quality": [], "delivery": []},
            "sprints": [
                {"id": 1, "name": "Sprint 1"},
