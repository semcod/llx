...
from ._docker import is_container_running as _is_container_running, docker_exec
...
class AIToolsManager:
    ...
    def execute_command(self, command: str, timeout: int = 30) -> Tuple[bool, str]:
        ...
        try:
            result = docker_exec(self.container_name, ["/bin/bash", "-c", command], timeout=timeout)
