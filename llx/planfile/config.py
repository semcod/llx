    ...
    DEFAULT_CONFIG = {
        ...
        "focus_areas": {
            "complexity": {
                ...
                "default_sprints": 3,
                "tasks": ["Analyze complexity", "Extract methods", "Reduce nesting", "Add tests"],
            },
            "duplication": {
                "description": "Eliminate duplicate code",
                "default_sprints": 2,
                "tasks": ["Find duplicates", "Extract common", "Create utilities"],
            },
            "tests": {
                "description": "Improve test coverage",
                "default_sprints": 2,
                "tasks": ["Analyze coverage", "Add unit tests", "Add integration tests"],
            },
            "docs": {
                "description": "Improve documentation",
                "default_sprints": 1,
                "tasks": ["Update README", "Add examples", "Create tutorials"],
            },
        },
        "execution": {
