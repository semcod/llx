...
class SmoketestDBSchema(BaseModel):
    ...
    updated_at: datetime = Field(
        ..., description="Timestamp when the database schema was last updated"
    )
...
class SmoketestDBSchemaRequest(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description="Description of the database schema request"
    )
    created_at: datetime = Field(
        ..., description="Timestamp when the database schema request was created"
    )
    updated_at: datetime = Field(
        ..., description="Timestamp when the database schema request was last updated"
    )
...
class SmoketestDBSchemaResponse(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description="Description of the database schema response"
    )
    created_at: datetime = Field(
        ..., description="Timestamp when the database schema response was created"
    )
    updated_at: datetime = Field(
        ..., description="Timestamp when the database schema response was last updated"
    )
