...
def example_create_strategy():
    ...
    create_strategy_command(output="my_strategy.yaml", model="qwen2.5:3b", local=True)
...
def example_verify_strategy():
    ...
    strategy = load_valid_strategy("my_strategy.yaml")
    issues = verify_strategy_post_execution(strategy=strategy, project_path=".", backend="github")
